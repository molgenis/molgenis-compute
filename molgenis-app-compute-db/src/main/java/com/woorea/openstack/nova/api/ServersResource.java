...
public class ServersResource {
	...
	public AssociateFloatingIp associateFloatingIp(String serverId, String fixedIpAddress, String floatingIpAddress) {
		com.woorea.openstack.nova.model.ServerAction.AssociateFloatingIp action = new com.woorea.openstack.nova.model.ServerAction.AssociateFloatingIp(fixedIpAddress, floatingIpAddress);
