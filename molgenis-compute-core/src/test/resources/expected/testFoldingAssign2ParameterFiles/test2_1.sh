...
#
declare MC_jobScript="test2_1.sh"
declare MC_jobScriptSTDERR="test2_1.err"
declare MC_jobScriptSTDOUT="test2_1.out"
...
rundir="TEST_PROPERTY(project.basedir)/target/test/benchmark/run/testFoldingAssign2ParameterFiles"
runid="testFoldingAssign2ParameterFiles"
