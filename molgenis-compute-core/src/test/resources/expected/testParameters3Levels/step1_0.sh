...
rundir="TEST_PROPERTY(project.basedir)/target/test/benchmark/run/testParameters3Levels"
runid="testParameters3Levels"
...
in="testParameters3Levelshellopost2post1"
