...
if [[ -z "$out_out" ]]; then echo "In step 'step1', parameter 'out_out' has no value! Please assign a value to parameter 'out_out'." >&2; exit 1; fi
echo "step1__has__out_out[0]=\"${out_out[0]}\"" >> $ENVIRONMENT_DIR/step1_0.env
