...
#
processJob "step1_0" "${MC_submitOptions}"
processJob "step1_1" "${MC_submitOptions}"
processJob "step1_2" "${MC_submitOptions}"
processJob "step1_3" "${MC_submitOptions}"
processJob "step2_0" "${MC_submitOptions}"
processJob "step2_1" "${MC_submitOptions}"
