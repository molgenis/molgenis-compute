...
#
declare MC_jobScript="step2_1.sh"
declare MC_jobScriptSTDERR="step2_1.err"
declare MC_jobScriptSTDOUT="step2_1.out"
...
rundir="TEST_PROPERTY(project.basedir)/target/test/benchmark/run/testRunLocally5_1_a"
runid="testRunLocally5_1_a"
