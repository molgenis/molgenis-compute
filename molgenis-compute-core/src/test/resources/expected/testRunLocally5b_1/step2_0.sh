...
rundir="TEST_PROPERTY(project.basedir)/target/test/benchmark/run/testRunLocally5b_1"
runid="testRunLocally5b_1"
...
creationDate="today"
out[0]=${step1__has__out[0]}
out[1]=${step1__has__out[1]}
